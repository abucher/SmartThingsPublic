 ...
 */
metadata {
	definition (name: "Panasonic Viera Control", namespace: "abucher", author: "Aaron Bucher") {
        capability "polling"
        capability "refresh"
	...
	tiles(scale: 2) {
        multiAttributeTile(name: "panasonicTv", type: "generic", width: 6, height: 4) {
